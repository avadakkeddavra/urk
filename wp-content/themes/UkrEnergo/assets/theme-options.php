...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'sections'        => array( 
      array(
        'id'          => 'main_page',
        'title'       => __( 'Главная', 'theme-text-domain' )
      ),
      array(
        'id'          => 'option_types',
        'title'       => __( 'Option Types', 'theme-text-domain' )
    ...
    array(
        'id'          => 'main_tab',
        'label'       => __( 'Главные', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'tab',
        'section'     => 'main_page',
      ),
    array(
        'id'          => 'sub_head_site',
        'label'       => __( 'Подзаголовок сайта', 'theme-text-domain' ),
        'desc'        => __( 'Укажите ваш Подзаголовок сайта' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'main_page',
    ),
        array(
        'id'          => 'head_site',
        'label'       => __( 'Заголовок сайта', 'theme-text-domain' ),
        'desc'        => __( 'Укажите ваш Заголовок сайта' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'main_page',
    ),
    ...
    array(
        'id'          => 'ur_adress',
        'label'       => __( 'Юридический адресс', 'theme-text-domain' ),
        'desc'        => __( 'Укажите ваш юридический адресс' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'main_page',
      ),
    array(
        'id'          => 'press_adress',
        'label'       => __( 'Почтовый адресс', 'theme-text-domain' ),
        'desc'        => __( 'Укажите ваш почтовый адресс' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'main_page',
      ),
        array(
        'id'          => 'phones',
        'label'       => __( 'Телефоны', 'theme-text-domain' ),
        'desc'        => __( 'Укажите ваши телефоны' ),
        'std'         => '',
        'type'        => 'list-item',
        'section'     => 'main_page',
        'settings'    => array( 
          array(
            'id'          => 'phone',
            'label'       => __( 'Ваш телефон', 'theme-text-domain' ),
            'desc'        => '',
            'std'         => '',
            'type'        => 'text',
          ),
    ...
    array(
        ...
        array(
        'id'          => 'work_hours',
        'label'       => __( 'Часы работы', 'theme-text-domain' ),
        'desc'        => __( 'Укажите вашы часы работы' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'main_page',
      ),
